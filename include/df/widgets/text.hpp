...
void draw_text(Renderer& r, int x, int y, const char* text,
               Color c, int scale = 1) noexcept;

/// Draw a right-aligned string.
void draw_text_right(Renderer& r, int x, int y, const char* text,
                     Color c, int scale = 1) noexcept;

/// Draw a centered string.
void draw_text_center(Renderer& r, int x, int y, const char* text,
                      Color c, int scale = 1) noexcept;
